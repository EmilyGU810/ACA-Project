---
title: "ACA Health Insurance Project"
author: "Hanxi Gu"
date: "2024-01-31"
output:
...
The statistics show that the uninsured rate across the states has declined over the five years from 2010. More than half of the states expanded their state medicares in 2016. The number of Medicaid enrollments has increased, on average, between 2013 and 2016.
...
# Correlation plot
numeric_df <- df[, sapply(names(df), function(var) is.numeric(df[[var]]) && var != "State_Medic_Exp_2016")]
correlation_matrix <- cor(numeric_df)
ggcorrplot(correlation_matrix, hc.order = TRUE, type = "lower", outline.color = "white", ggtheme = ggplot2::theme_gray,  colors = c("#6D9EC1", "white", "#E46726"), lab = TRUE)
```
