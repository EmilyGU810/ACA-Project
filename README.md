...
${\textsf{\color{red}You \space can \space click \space on \space the \space HTML \space file \space and \space then \space download \space it \space by \space clicking \space on \space the \space top \space right \space icon}}$
